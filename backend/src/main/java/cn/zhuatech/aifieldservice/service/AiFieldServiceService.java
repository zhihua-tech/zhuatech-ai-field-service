...
import cn.zhuatech.aifieldservice.domain.DomainCatalog;
import cn.zhuatech.aifieldservice.model.*;
import cn.zhuatech.aifieldservice.repository.*;
 ...
 */
@Service
public class AiFieldServiceService {
     ...
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
    public AiFieldServiceService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
